...
<div class="container">
  <div class="row">
    <div class="col-md-10 col-sm-10 mx-auto p-4 border" style="background-color: #f2f2f2;">
        ...
        <div class="row p-2">
            <div class="col-12">
                <h3 class="title" align="center">Product Feature Update</h3>
            </div>
        </div>

        <form class="form-inline my-5"  method="post" action="{{ route('product_features.update', $productFeature->id) }}" enctype="multipart/form-data">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
            @include('admin.product.product_feature.form')
