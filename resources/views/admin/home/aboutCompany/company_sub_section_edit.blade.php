		...
		<div class="col-md-10 col-sm-12 mx-auto p-4 border">
			<div class="col-md-10 col-sm-10 mx-auto p-4 border" style="background-color: #f2f2f2;">
				<div class="panel-heading " >
					<h3 class="title" align="center">Company Sub Section</h3>
					<hr>
					@if (count($errors) > 0)
				...
				<form class="form-inline" action="{{url('/company_sub_section/'.$com_sub_section->id)}}" method="post" enctype="multipart/form-data">
				{{ method_field('PUT') }}
				@csrf
					...
					<div class="row">
						...
						@include('admin.home.aboutCompany.company_sub_section_editform')
