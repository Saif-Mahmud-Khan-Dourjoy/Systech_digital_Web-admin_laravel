...
<div class="container">
  <div class="row">
    <div class="col-md-10 col-sm-10 mx-auto p-4 border" style="background-color: #f2f2f2;">
      <div class="panel-heading " >
        <h3 class="title" align="center">Service Feature Form</h3>
        <hr>
        @if (count($errors) > 0)
  ...
  <p class="d-inline-block" style="font-size: 20px; font-weight: bold;">Service Feature</p>
  <span class="d-inline-block service_feature_add"><i class="d-inline-block fas fa-plus-circle fa-2x text-success "></i></span>
  <span class="d-inline-block service_feature_remove"><i class="d-inline-block fas fa-minus-circle fa-2x text-danger"></i></span>
</div>
   <div class="border p-4">

      <form class="form-inline" action="{{url('/service_features')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row service_feature_content">
           
        @include('admin.home.serviceFeature.form')
          </div>
...
<script type="text/javascript">
        $('.service_feature_add').click(function(){
       var bhtml = '<div class="row feature "><div class="col-md-4 "><div class="form-group"><label class="" for="head_text">Head Text:</label><input type="text" name="head_text[]" class="form-control" value="" id="head_text"></div> </div><div class="col-md-4 "><div class="form-group"><label class="" for="sub_text">Sub text:</label><input type="text" name="sub_text[]" class="form-control" value="" id="sub_text"></div></div><div class="col-md-4 "><div class="form-group"><label class="" for="icon">Icon:</label><input type="file" name="icon[]" class="form-control" value="" id="icon"></div> </div></div>';
        $('.service_feature_content').append(bhtml); 
       
      });
      $('.service_feature_remove').click(function(){
        $('.feature:last').remove();
      });
</script>
@endsection
